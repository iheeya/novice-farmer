...
import { addPlantPost } from '../../services/AddGarden/AddGardenPost';
...
function AddPlantModal({  onClose, plantId, plantName }: GardenModalProps) {
  ...
  const MyPlace = Number(myPlaceId);
