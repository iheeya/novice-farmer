...
import { getInfoPestDetail } from "../../services/Information/InfoApi";
...
export default function InfoPestDetail() {
  ...
  useEffect(() => {
    if (title) {
      getInfoPestDetail(title)
        ...
        .catch((err) => {
          console.error("Error fetching pest detail:", err);
        });
    }
  }, [title]);
